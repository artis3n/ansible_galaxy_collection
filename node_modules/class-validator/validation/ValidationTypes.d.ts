...
export declare class ValidationTypes {
    ...
    static IS_ISO31661_ALPHA_2: string;
    static IS_ISO31661_ALPHA_3: string;
    ...
    static IS_FIREBASE_PUSH_ID: string;
    ...
    static IS_HASH: string;
    static IS_ISSN: string;
