...
describe('AsYouType', function () {
  ...
  it('should populate international number template (digit by digit) (default country)', function () {
    ...
    formatter.formatter.populatedNationalNumberTemplate.should.equal('xxx xxx xxxx'); // Has some national number digits, starts formatting the phone number using the template.
  ...
  it('should populate international number template (digit by digit)', function () {
    ...
    expect(formatter.formatter.populatedNationalNumberTemplate).to.be.undefined;
    formatter.input('1').should.equal('+1');
    formatter.formatter.template.should.equal('xx xxx xxx xxxx'); // Hasn't yet started formatting the phone number using the template.
  ...
  it('should work with Mexico numbers', function () {
    var asYouType = new AsYouType('MX'); // Fixed line.
    ...
    asYouType.getTemplate().should.equal('xxx xxx xxxx'); // Mobile.
    ...
    asYouType.getTemplate().should.equal('xxx xx xxxx xxxx'); // Google's `libphonenumber` seems to not able to format this type of number.
